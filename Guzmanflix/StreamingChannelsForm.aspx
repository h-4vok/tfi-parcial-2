<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Title="Gestión de Canales" CodeBehind="StreamingChannelsForm.aspx.cs" Inherits="Guzmanflix.StreamingChannelsForm" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %>.</h2>
    <h3>Cree, Edite y Elimine Canales de Streaming</h3>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label>Series</label>
                <asp:ListBox ID="lstShows" SelectionMode="Multiple" Height="200px" runat="server"></asp:ListBox>
            </div>
        </div>
    </div>
